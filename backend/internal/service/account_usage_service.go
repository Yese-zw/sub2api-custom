...
type UsageLogRepository interface {
	...
	GetProfitTrend(ctx context.Context, startTime, endTime time.Time, timezone string) ([]usagestats.ProfitTrendPoint, error)
	GetProfitSummary(ctx context.Context, startTime, endTime *time.Time) (*usagestats.ProfitSummary, error)
	GetCurrentTotalUserBalance(ctx context.Context) (float64, error)
