...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/profit-trend", h.Admin.Dashboard.GetProfitTrend)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/upstream-balances/refresh", h.Admin.Account.RefreshUpstreamBalances)
		accounts.POST("/:id/clear-rate-limit", h.Admin.Account.ClearRateLimit)
		accounts.POST("/:id/reset-quota", h.Admin.Account.ResetQuota)
		accounts.POST("/:id/upstream-balance/refresh", h.Admin.Account.RefreshUpstreamBalance)
		accounts.PUT("/:id/upstream-balance/config", h.Admin.Account.UpdateUpstreamBalanceConfig)
